...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer QBPORGi9UnftrzZlFoVeVQ9YqRG6PYo8' http://a2f0fcb8-c1a1-4c7a-bc06-5a482a985bea.germanywestcentral.azurecontainer.io/score
